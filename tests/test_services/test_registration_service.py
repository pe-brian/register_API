...
class TestRegistrationService:
    ...
    def test_register(
        self, mock_activation_code_create: MagicMock, mock_user_create: MagicMock
    ):
        with patch.object(
            RegistrationService, "dispatch_service", MagicMock()
        ) as mock_dispatch, patch.object(
            RegistrationService, "code_sender_service", MagicMock()
        ) as mock_code_sender:
            ...
            mock_dispatch.dispatch.assert_any_call(
